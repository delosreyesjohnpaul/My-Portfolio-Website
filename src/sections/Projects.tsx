...
export const ProjectsSection = () => {
  ...
  <section className="pb-16 lg:py-24">
    <div className="container ">
      ...
      <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto">See how I use machine learning to turn data into actionable insights and engaging experiences.</p>
      <div className=" mt-10 md:mt-20 flex flex-col gap-20">
        {portfolioProjects.map(project => (
          ...
          p-8 pt-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20 after:pointer-events-none">
